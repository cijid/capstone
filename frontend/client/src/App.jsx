...
function App() {
  ...
  function ProtectedRoute({ children, type }) {
    ...
    if (type && user?.branch != type && !user.admin)
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route
            ...
            element={
              <ProtectedRoute>
                <CapabilityDependenciesDashboard />
              </ProtectedRoute>
            }
          />
        </Routes>
