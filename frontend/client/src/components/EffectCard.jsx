function EffectCard({ effect, onView, onEdit, onDelete }) {
  return (
    <article className="sf-effect-card">
      <div className="effect-main">
        ...
        <p className="effect-location">{effect.location}</p>
      </div>
      ...
      <div className="effect-actions">
        <button onClick={() => onView(effect)}>View Details</button>

        <button onClick={() => onEdit(effect)}>Edit</button>
