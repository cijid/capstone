function EditEffectForm({ effect, onChange, onSubmit, onCancel }) {
  if (!effect) {
    return null;
  }
        ...
        <form className="report-form" onSubmit={onSubmit}>
          <label>
            ...
            <select
              ...
              value={effect.capabilityCategory}
              onChange={onChange}
            >
          ...
          <label>
            ...
            <textarea
              ...
              value={effect.recommendedAction || ""}
              onChange={onChange}
              rows="3"
            />
          </label>
          ...
          <div className="form-row">
            <label>
              ...
              <input
                type="datetime-local"
                name="startTime"
                value={formatDateTimeLocal(effect.startTime)}
                onChange={onChange}
              />
            </label>
            ...
            <label>
              ...
              <input
                type="datetime-local"
                name="endTime"
                value={formatDateTimeLocal(effect.endTime)}
                onChange={onChange}
              />
            </label>
          </div>
