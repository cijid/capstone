...
exports.seed = async function(knex) {
  ...
  await knex('informational_awareness').insert([
    ...
    {id: "infoAw3", terrain: 'Desert roads, rolling hills, and urban routes', intelligence: "Geospatial Intelligence (GEOINT)", device_ids: JSON.stringify(["device7", "device8"])},
     {id: "infoAw4", terrain: 'Open fields, clearings, and hilltops', intelligence: "Measurement and Signature Intelligence (MASINT)", device_ids: JSON.stringify(["device9", "device10"])},
    {id: "infoAw5", terrain: 'Urban areas and rugged terrain', intelligence: "Imagery Intelligence (IMINT)", device_ids: JSON.stringify(["device11", "device12"])},
