...
exports.seed = async function (knex) {
  ...
  await knex("mission").insert([
    ...
    },
    {
      ...
      mission_description:
        "Use simulated infrared and radar observations to test missile detection, tracking, and data processing workflows between Colorado Springs and San Diego.",
    ...
    },
    {
      ...
      mission_description:
        "Validate receipt and display of simulated missile warning alerts at the temporary field site near Barstow and the support center in San Diego.",
    ...
    },
    {
      ...
      mission_description:
        "Test the transfer, processing, and display of simulated missile warning sensor reports between a field team near Yuma and Colorado Springs",
    ...
    },
    {
      ...
      mission_description:
        "Evaluate GNSS position reports and inertial navigation outputs at the remote site near Nome, with results reviewed by the monitoring team in Anchorage.",
    ...
    },
    {
      ...
      mission_description:
        "Compare timing receiver outputs against reference clocks at field headquarters near Fayetteville and the coordination center in Arlington to verify timestamp consistency.",
