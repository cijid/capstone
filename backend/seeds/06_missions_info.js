...
exports.seed = async function(knex) {
  ...
  await knex('mission').insert([
    ...
    { id: "mission3", 
      ...
      mission_description: "Maintain satellite voice and data connectivity between a convoy near Tucson and the Phoenix operations center. Configure the Hughes 9211 with a tracking antenna for mobile use.", 
