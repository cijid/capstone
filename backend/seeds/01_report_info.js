...
exports.seed = async function (knex) {
  ...
  await knex("report").insert([
    ...
    },
    {
      ...
      confidence: 82,
      description:
        "Intermittent signal loss detected during a scheduled SATCOM session with terminal T118",
    ...
    },
    {
      ...
      confidence: 88,
      description:
        "Backup SATCOM link validation requested for terminal T305 before scheduled maintenance",
    ...
    },
    {
      ...
      confidence: 95,
      description:
        "Higher-than-expected latency observed on terminal T212 during routine data transfer",
      recommended_action:
        "Evaluate sat U36 and compare latency against the current link",
    ...
    },
    {
      ...
      confidence: 78,
      description:
        "Reduced signal strength reported on terminal T409 following equipment relocation.",
    ...
    },
    {
      ...
      confidence: 93,
      description:
        "Primary SATCOM link unavailable for terminal T501 during a scheduled communications window.",
      recommended_action:
        "Activate the backup link using sat U38 and investigate the primary connection.",
    ...
    },
    {
      ...
      confidence: 97,
      description:
        "SATCOM connectivity restored on terminal T610 following routine maintenance",
      recommended_action:
        "Continue using sat U39 and monitor signal stability.",
